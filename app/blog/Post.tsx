...
export const SinglePost: React.FC<Post> = ({
  ...
  <div className="bg-darkSecondary/70 w-96 md:w-1/2 lg:w-1/4 h-64 transition ease-in-out duration-300 md:hover:bg-darkSecondary md:hover:scale-110 cursor-pointer">
    <Link
      href={`/blog/${id}`}
